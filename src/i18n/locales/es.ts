const es = {
  ...
  banks: {
    ...
    aiProposals: {
      title: 'Propuestas de clasificación con IA',
      loading: 'Cargando propuestas de IA...',
      loadError: 'No se pudieron cargar las propuestas de IA',
      empty: 'No hay propuestas de IA pendientes',
      pendingBadge: 'Propuesta de IA pendiente',
      proposedAccount: 'Cuenta propuesta',
      role: 'Rol',
      proposedEntity: 'Entidad propuesta',
      accept: 'Aceptar',
      correct: 'Corregir',
      reject: 'Rechazar',
      correctTitle: 'Corregir la clasificación propuesta',
      confirmCorrect: 'Confirmar corrección',
      accepted: 'Propuesta aceptada',
      corrected: 'Propuesta corregida',
      rejected: 'Propuesta rechazada',
      decisionFailed: 'No se pudo aplicar la decisión',
      alreadyResolved: 'La propuesta ya fue resuelta',
      notFound: 'La propuesta ya no existe',
      accessError: 'No tienes permiso para decidir esta propuesta',
    },
  ...
  bankRules: {
    ...
    confidenceLow: 'Baja',
    ambiguousTxTitle: 'Transacciones ambiguas',
    transaction: 'Transacción',
    applySelectedRule: 'Aplicar',
    ambiguityResolved: 'Ambigüedad resuelta correctamente',
    ...
    errors: {
      ...
      resolveFailed: 'Error al resolver ambigüedad',
  ...
  learning: {
    ...
    conflicts: {
      ...
      subtitle: 'Conflictos deterministas pendientes registrados por el motor de conocimiento. La resolución es una decisión humana; la rehabilitación es una acción explícita separada.',
      empty: 'No hay conflictos de clasificación pendientes.',
      fetchError: 'No se pudieron cargar los conflictos pendientes.',
      kindLabel: 'Tipo',
      glAccountLabel: 'Cuenta contable en conflicto',
      detectedAtLabel: 'Detectado en',
      observationIdsLabel: 'Observaciones',
      authorizedPatternsLabel: 'Patrones autorizados',
      exactTreatmentsLabel: 'Tratamientos exactos',
      reasonLabel: 'Motivo de la resolución (obligatorio)',
      reasonPlaceholder: '¿Por qué es correcto este tratamiento?',
      resolveBtn: 'RESOLVER CONFLICTO',
      resolving: 'Resolviendo...',
      resolved: 'Conflicto resuelto. La rehabilitación del conocimiento sigue siendo un paso separado.',
      alreadyResolved: 'El conflicto ya fue resuelto.',
      resolutionRecorded: 'Resolución registrada. Ahora puede rehabilitar explícitamente el conocimiento implicado si corresponde.',
      rehabilitateLabel: 'Rehabilitar conocimiento (acción explícita separada)',
      selectTarget: 'Seleccione un ítem de conocimiento implicado...',
      rehabilitateBtn: 'REHABILITAR CONOCIMIENTO',
      rehabilitating: 'Rehabilitando...',
      rehabilitated: 'Conocimiento rehabilitado a cierto',
      alreadyCertain: 'El conocimiento ya es cierto',
      rehabilitateDisabledHint: 'Resuelva primero el conflicto. La rehabilitación nunca es automática.',
      rehabilitateRefused: 'La rehabilitación no fue aplicada.',
      rehabilitateFailed: 'La rehabilitación falló.',
      resolveFailed: 'La resolución falló.',
    },
  },
  transactionIntent: {
  ...
  entityManagement: {
    ...
    actions: {
      ...
      bulkReclassify: 'Reclasificar Seleccionados',
      reclassify: 'Reclasificar',
    },
    otrosReview: 'OTRO Pendientes',
    allEntities: 'Todas las Entidades',
    reclassify: {
      title: 'Reclasificar Entidades OTRO',
      description: 'Asigná un nuevo rol a {count} entidad(es) actualmente marcadas como Otro.',
      roleLabel: 'Nuevo Rol',
      submit: 'Asignar Rol',
      success: '{count} entidad(es) reclasificada(s) exitosamente.',
      noSelection: 'Seleccioná entidades para reclasificar.',
      noOtros: 'No hay entidades OTRO pendientes de revisión.',
    },
    edit: {
