const es = {
  ...
  learning: {
    ...
    onboardingDesc:
      'Estas entidades fueron detectadas en tus transacciones pero aun no tienen una clasificacion. Asignales un rol para mejorar el matching automatico. Opcionalmente podes agregar una intencion de transaccion.',
    ...
    saving: 'Guardando...',
    customRoleName: 'Nombre del rol personalizado...',
    customRoleRequired: 'Ingresá un nombre para el rol personalizado',
    ...
    rolePlaceholder: 'Seleccioná un rol...',
    accountPlaceholder: 'Seleccioná una cuenta contable...',
    aiConfigError:
      'La configuración de IA no está establecida. Configurá el proveedor de IA en ajustes.',
    ...
    directionCreditError:
      'La cuenta sugerida no es válida para transacciones de INGRESO. Ajustá el rol o seleccioná una cuenta de Ingreso/Pasivo.',
    directionDebitError:
    ...
    manualSelection: 'Seleccionar manualmente',
  ...
  entityManagement: {
    ...
    filter: {
      roleLabel: 'Filtrar por Rol',
      allRoles: 'Todos los roles',
      unclassified: 'Sin clasificar / Sin Rol',
    },
    columns: {
      pattern: 'Patrón',
      role: 'Rol',
    ...
    warning: {
      combinedRules:
        'Los cambios de rol afectan solo a futuras reglas combinadas. Las transacciones históricas no se alteran.',
    },
    role: {
